    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dept_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='employeedetail.department')),
            ],
        ),
        migrations.CreateModel(
            name='emp_detail',
            fields=[
                ...
                ('special_role', models.CharField(default='none', max_length=50)),
                ('designation_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='employeedetail.designation')),
            ],
        ),
        migrations.CreateModel(
            name='pay_slip_info',
