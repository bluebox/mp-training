...
function MyProfile() {
  ...
  const handleLogOut = (e) => {
   ...
   const response= fetch("http://127.0.0.1:8000/store/logout/"+localStorage.getItem('id'))
    navigate("/")
  }
  ...
  return (<>   <nav className="nav-link">
    ...
    <button className='nav-button' onClick={handleLogOut}>LogOut</button>
      ...
      <div className="my-profile" id="test_requests">
        ...
        <button title="Edit" className="edit-profile-button" onClick={() => navigate('/CustomerRegisterPage', { state: { 'username': username ,'from':'customer'} })}>✏️
