/*package com.LmsFx.controller;

import com.LmsFx.dao.MemberDao;
import com.LmsFx.model.Member;
import com.LmsFx.service.MemberService;
...
public class AddMemberController {
    ...
    private void handleAddMember() {
        ...
        String validationError = MemberService.validate(enteredName, enteredEmail, enteredMobile, selectedGender, enteredAddress);
...
public class AddMemberController {
    ...
    private void handleAddMember() {
        ...
        try {
			...
			Validator.isUniqueMobileNumber(enteredMobile);
