...
dob date,
age int unsigned generated always as(timestampdiff(year,dob,curdate())) virtual ,
Date_Joined date,
...
insert into DepartmentHeads(Emp_Id,dept_head_id,dept_id,Manager_Since) values (2345,3,1,'2021-12-04'),(2456,1,2,'2022-09-03'),(2347,5,3,'2021-12-04'),(2356,6,4,'2022-09-03'),(2245,2,5,'2021-12-04'),(2496,4,6,'2022-09-03');
