package ExcelAnaltysis.EmployeeDataAnalysis;
...
public class App {
    ...
    public static void main(String[] args) {
        try {
        	...
        	String path = "Sample_Employee_WorkLogs.xlsx";
        	String pathNew = "EmployeeDataAnalysis//src//main//java/ExcelAnaltysis//EmployeeDataAnalysis//Sample_Employee_WorkLogs.xlsx";
            String inputPath = "/home/developer/eclipse-workspace/EmployeeDataAnalysis/src/main/java/ExcelAnaltysis/EmployeeDataAnalysis/Sample_Employee_WorkLogs.xlsx";
