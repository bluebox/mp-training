...
public class Member extends Person {
	...
	public MembershiPlan getPlan() {
		return plan;
	}
	public void setPlan(MembershiPlan plan) {
		this.plan = plan;
	}
	  public void assignPlan(MembershiPlan plan) {
	        this.plan = plan;
	    }
	@Override
	...
	public static Member fromFileString(String line) {
	    ...
	    if (!planName.equals("None")) {
	        m.assignPlan(new MembershiPlan(planName, duration, fee));
	    }
	    return m;
	}
