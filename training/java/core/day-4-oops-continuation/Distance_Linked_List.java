...
public class Distance_Linked_List {
	...
	public static void main(String[] args) {
		...
		Place naviMumbai = new Place("Navi Mumbai", 30);
		addPlace(placesToVisit, naviMumbai);
		addPlace(placesToVisit, new Place("Pune", 150));
		addPlace(placesToVisit, new Place("Hyderabad", 710));
		addPlace(placesToVisit, new Place("Bengaluru", 980));
		addPlace(placesToVisit, new Place("Chennai", 1330));
		addPlace(placesToVisit, new Place("Kolkata", 2000));

		placesToVisit.addFirst(new Place("Mumbai", 0));
