...
public class Student {
    ...
    public double getPercentComplete(String courseCode) {
        ...
        return (info == null) ? -1 : info.getPercentComplete();
    }
    ...
    public static Course[] getRandomCourses(Course... courses) {
    	int randomSize = random.nextInt(1,courses.length+1);
    	
    	List<Course> courseList = Arrays.asList(courses); 
    	Collections.shuffle(courseList);
    	return courseList.subList(0, randomSize).toArray(new Course[0]);
    }
