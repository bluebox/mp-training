...
//    private static final String PASSWORD = "9490";
//
...
//                    if (rs.next()) {
//                        insertBookLogStmt.setInt(1, rs.getInt("BookId"));
//                        insertBookLogStmt.setString(2, rs.getString("Title"));
//                        insertBookLogStmt.setString(3, rs.getString("Author"));
//                        insertBookLogStmt.setString(4, rs.getString("Category"));
//                        insertBookLogStmt.setString(5, rs.getString("Status"));
//                        insertBookLogStmt.setString(6, rs.getString("Availability"));
...
//
//            String selectIssueSql = "SELECT * FROM issue_records WHERE BookId = ? AND MemberId = ? AND Status = 'I'";
...
//                        insertIssueLogStmt.setDate(6, Date.valueOf(LocalDate.now()));
...
public class Issue_RecordDAO implements issuerecordinterface {
	...
	private final static String USER="devuser";
	private final static String PASSWORD="Bobby@514";
    ...
    public static void main(String[] args) throws SQLException {
    	Issue_RecordDAO i=new Issue_RecordDAO();
    	System.out.println(i.printAllIssueRecords());
    }
