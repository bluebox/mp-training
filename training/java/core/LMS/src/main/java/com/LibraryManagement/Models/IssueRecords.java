...
public class IssueRecords {
	...
	public IssueRecords(int bookId, int memberId, char status, LocalDate issueDate) {
        this.bookId = bookId;
        this.memberId = memberId;
        this.status = status;
        this.issueDate = issueDate;
...
//	public IssueRecords(Integer bookId, Integer memberId, char c, LocalDate issueDate) {
