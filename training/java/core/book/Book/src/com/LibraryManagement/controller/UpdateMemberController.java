...
public class UpdateMemberController {
	...
	private void handleUpdate() {
		...
		boolean isSame = name.equals(selectedMember.getName()) && email.equals(selectedMember.getEmail())
				&& mobile == selectedMember.getMobile() && gender.equals(selectedMember.getGender())
