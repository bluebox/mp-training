...
public class HttpClientPOST {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            String parameters = "frist Name = Vardhan & Last Name = Rangineni";
            int length = parameters.getBytes().length;
            connection.setRequestProperty("Count-Length",String.valueOf(length));
            ...
            if (responseCode != HTTP_OK) {
                System.out.println("Web Page Error " + url);
                System.out.printf("Error: ",connection.getResponseMessage());
                return;
            }
