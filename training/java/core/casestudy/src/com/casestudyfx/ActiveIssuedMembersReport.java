...
public class ActiveIssuedMembersReport extends VBox {
	...
	public ActiveIssuedMembersReport(List<IssueRecord> issueRecords) {
		...
		memberIdCol
				.setCellValueFactory(data -> new SimpleStringProperty(String.valueOf(data.getValue().getMemberId())));
		...
		returnDateCol.setCellValueFactory(data -> new SimpleStringProperty(data.getValue().getReturnDate() != null
