...
//	Delete Event By Event Id
	public int deleteEventById(int eventId) throws Exception{
	   ...
	   public boolean increaseParticipantsCount(int eventId,int total,int available)
	    {
	        ...
	        return jdbcTemplate.update(sql,available+1, eventId) == 1;
	    }
	    
	    public boolean decreaseParticipantsCount(int eventId,int available)
	    {
	    	String sql = "UPDATE eventCreation SET participation_count=? WHERE event_id=?";
	        return jdbcTemplate.update(sql,available-1, eventId) == 1;
	    }
