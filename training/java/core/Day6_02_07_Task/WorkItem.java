...
public class WorkItem {
    ...
    public WorkItem(String assignedTo, String projectName, String taskDetails, Status status, Priority priority) {
    ...
    public WorkItem(String assignedTo, String projectName, String taskDetails) {
