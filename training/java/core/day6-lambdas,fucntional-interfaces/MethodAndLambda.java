...
public class MethodAndLambda {
	...
	public static void main(String[] args) {
		String[] names = { "Kaushik", "Anu", "Ravi" };

		List<UnaryOperator<String>> ops = Arrays.asList(String::toLowerCase, // method reference
				s -> s.substring(0, 1).toUpperCase() + s.substring(1), // lambda
				addRandomMiddleInitial // custom lambda
		);
