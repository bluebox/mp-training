...
public class Interface_UtilityLine implements Interface_Mappable {

    private String name;
    private UtilityType type;

    public Interface_UtilityLine(String name, UtilityType type) {
        this.name = name;
        this.type = type;
    }
    ...
    public String toJSON() {
        return Interface_Mappable.super.toJSON() + """
