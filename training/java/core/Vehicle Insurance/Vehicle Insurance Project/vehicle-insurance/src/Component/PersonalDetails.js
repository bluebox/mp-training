...
function UserRegistration(){
    ...
    // useEffect(()=>{
    //     fetch("http://10.129.241.187:8000/customer/getByEmail?email="+{email}, {
    //         method: "GET"
    //     })
    //     .then((res)=>{
    //         if(!res.ok) {
    ...
    function setData(event){
        ...
        // headers.append('Access-Control-Allow-Origin', 'http://10.129.241.187:3000');
        // headers.append('Access-Control-Allow-Credentials', 'true');
        // headers.append('GET', 'POST', 'OPTIONS');
        // headers.append("Authorization","Basic"+base64.encode("srinu"+":"+"43434"));
        fetch("http://10.129.241.187:8000/customer/add",{
            method:"POST",
            headers:headers,
            body:formDetails,
            credentials:"include"
