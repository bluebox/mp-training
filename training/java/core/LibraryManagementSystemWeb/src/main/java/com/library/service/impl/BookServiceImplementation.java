...
//    private final IssueRecordService issueService = new IssueRecordServiceImplementation();
    ...
    public void updateAvailability(int bookId, char availability) throws Exception {
        ...
        try {
            ...
            if (availability == 'A' && activeIssue != null) {
                throw new IllegalStateException("Book is currently issued. Cannot mark it as Available.");
            }

            if (availability == 'I' && activeIssue == null) {
                throw new IllegalStateException("Book is not issued. Cannot mark it as Issued manually.");
            }
