...
public interface Mappable {
	...
	default String toJSON() {
		return String.format(JSON_PROPERTY, String.format("\"type\": \"%s\", \"label\": \"%s\", \"marker\": \"%s\"",
	...
	static void mapIt(Mappable mappable) {
		...
		if (mappable instanceof Building building) {
			...
			System.out.printf("\"name\": \"%s\", \"utility\": \"%s\"%n", utilityLine.getName(),
					utilityLine.getUtility());
		}
	}
}
