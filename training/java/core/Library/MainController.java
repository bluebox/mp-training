...
public class MainController {
    ...
    private void handleUpdateMember(ActionEvent event) {
        ...
        try {
            ...
            Parent root = loader.load();
            Stage stage = new Stage();
            stage.setTitle("Update Member deatils");
            stage.setScene(new Scene(root));
            stage.show();
        } catch (Exception e) {
            e.printStackTrace();
    ...
    @FXML
    private void handleAllBooks(ActionEvent event) {
        System.out.println("All Books button clicked");
        // Add your code here to open All Books UI
        try {
