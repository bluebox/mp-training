...
public class VehicleController {
	...
	@PutMapping("/update")
	public String updateVehicleNumber(@RequestParam int vehicleId,@RequestParam String regNum,@RequestParam String updatedBy) throws Exception {
	...
	@GetMapping("/showByReg")
	public Vehicle showVehicleById(@RequestParam String regNum) throws Exception {
		return vehicleService.getVehicleByRegNum(regNum);
	}
