...
//	
	...
	public List<Vehicle> getAllVehiclesByCustomer(int customerId) {
		String sql = "Select vehicle_id,chasis_no,reg_num,vehicle_model,purchase_date,vehicle_updated_on,vehicle_updated_by,customer_id,created_by,status from vehicles where customer_id=?";
