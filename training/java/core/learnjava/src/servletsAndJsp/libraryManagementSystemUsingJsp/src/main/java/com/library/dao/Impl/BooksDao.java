...
public class BooksDao {
	...
	public List<Book> searchByName(String name) throws SQLException {
		...
		while(rs.next()) {
			...
			book.add(new Book(bookId, title, author, category, Status.fromCode(status),Availability.fromCode(availability)));
