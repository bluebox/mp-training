...
public class ServiceTest {
    ...
    public void testAddBook() {
        Book book = new Book(0, "JUnit Book", "Test Author", "Testing", Status.ACTIVE, Availability.YES);
    ...
    public void testUpdateBookService() {
        Book book = new Book(1, "Updated Title", "Updated Author", "Testing", Status.ACTIVE, Availability.NO);
