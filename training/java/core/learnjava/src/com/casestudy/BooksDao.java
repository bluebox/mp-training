...
public class BooksDao {
    ...
    public List<Book> viewAllBooks() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                books.add(new Book(bookId, title, author, category,Status.fromCode(status), Availability.fromCode(availability)));
            }
    ...
    public boolean CanBeIssued(int bookId) {
        try (Connection conn = DBUtil.getConnection();
             PreparedStatement ps = conn.prepareStatement("SELECT status, availability FROM books WHERE bookId = ?")) {
