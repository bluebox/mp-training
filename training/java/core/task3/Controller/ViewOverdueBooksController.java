...
public class ViewOverdueBooksController {
    @FXML private TableView<IssueRecord> overdueTable;
    @FXML private TableColumn<IssueRecord, Integer> issueIdColumn, bookIdColumn, memberIdColumn;
    @FXML private TableColumn<IssueRecord, java.time.LocalDate> issueDateColumn;
    private IssueService issueService = new IssueService();
    private Stage primaryStage;

    public ViewOverdueBooksController(Stage primaryStage) {
