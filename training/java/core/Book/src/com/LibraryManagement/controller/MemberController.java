...
public class MemberController {
	...
	@FXML
	private Button addMemberButton, viewMembersButton, updateButton;
	@FXML
	private TextField memberIdField, nameField, emailField, mobileField;
	@FXML
	private ComboBox<String> genderCombo;
	@FXML
	private TextArea addressArea;
	@FXML
	private Label nameErrorLabel, emailErrorLabel, mobileErrorLabel, genderErrorLabel, addressErrorLabel;
	@FXML
	private TableView<Member> membersTable;
	@FXML
	private TableColumn<Member, Integer> memberIdColumn;
	@FXML
	private TableColumn<Member, String> nameColumn, emailColumn, genderColumn, addressColumn;
	@FXML
	private TableColumn<Member, Long> mobileColumn;
	@FXML
	...
	@FXML
	public void Backu(ActionEvent event) {
		try {
			MainController.switchScene("members/MembersForm.fxml");
		} catch (Exception e) {
			e.printStackTrace();
	...
	private void openMemberForm(Member member) {
		try {
			FXMLLoader loader = new FXMLLoader(
					getClass().getResource("/com/LibraryManagement/application/members/UpdateMemberForm.fxml"));
	...
	private void handleViewMembers() {
		try {
			FXMLLoader loader = new FXMLLoader(
					getClass().getResource("/com/LibraryManagement/application/members/ViewMembersForm.fxml"));
			Parent root = loader.load();
	...
	private void handleRegister() {
		...
		Member m = new Member(nameField.getText().trim(), emailField.getText().trim(),
				...
				String.valueOf(genderCombo.getValue().equals("Male") ? "M" : "F"), addressArea.getText().trim());
