...
public class ServiceLayer implements ServiceInterface{
	...
	@Override
	public Book updateBookDetails(Book updatebook) throws SQLException {
	Book book=bookimplementation.updateBookDetails(updatebook);
	if(book != null) {
		return book;
	}
	...
	public List<IssueRecord> getAllIssueRecords() throws SQLException {
	 ...
	 @Override
	    public void registerMember(Member member) throws Exception {
	        ...
	        if (!Pattern.matches("^[a-zA-Z0-9_]+(?:\\.[a-zA-Z0-9_]+)*@(?:[a-zA-Z0-9]+\\.)+[a-zA-Z]{2,7}$", member.getEmail())){
