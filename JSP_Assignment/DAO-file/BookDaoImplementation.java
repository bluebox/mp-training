...
public class BookDaoImplementation {
    ...
    public void addBook(Connection conn, Book book) throws Exception {
    ...
    public void updateBook(Connection conn, Book book) throws Exception {
        String updateSql = "UPDATE books SET Title = ?, Author = ?, Category = ?, Status = ? WHERE Id = ?";
    ...
    public void updateAvailability(Connection conn, int bookId, char availability) throws Exception {
        ...
        String updateSql = "UPDATE books SET Availability = ? WHERE Id = ?";
    ...
    public List<Book> searchBooks(String columnName, String value) throws Exception {
    ...
    private void logBookAction(Connection conn, int bookId, String actionType) throws Exception {
        String selectSql = "SELECT Title, Author, Category, Status, Availability FROM books WHERE Id = ?";
        ...
        try (PreparedStatement stmt = conn.prepareStatement(selectSql)) {
            ...
            String insertSql = "INSERT INTO bookslog (id, title, author, category, status, availability, actiontype) VALUES (?, ?, ?, ?, ?, ?, ?)";
    ...
    public Book getBookByTitleAuthorCategory(String title, String author, String category) throws SQLException {
        String sql = "SELECT * FROM books WHERE title = ? AND author = ? AND category = ?";
