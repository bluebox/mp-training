...
public class Task {
	...
	private static final String password="Santhosh@123";	
	public static void main(String[] args) {
		Connection c=connectionestablish();
		String csvpath="C:\\Users\\Santhosh\\Downloads\\employee_work_log_v2.csv.xlsx";
	...
	public static void addrecordstodb(Connection c,List<List<String>> records) {
		 ...
		 String query = "insert into employee.employeerecord (employee_id, name, department, project_id, date, task_category, hours_worked, remarks) values (?, ?, ?, ?, ?, ?, ?, ?)";
...
String query="select * from employeerecord";
		...
		try {
			...
			try {
				File file=new File("C://Users//Santhosh//Desktop//1stweekchallenges//Public//assets//new_log_employee_details.csv.xlsx");
