    ...
    public void handleIssueBook() {
        try {
            ...
            if (!bookIdText.matches("\\d+")) {
                throw new InvalidInputException("Book ID must be a number.");
            }
            ...
            if (!memberIdText.matches("\\d+")) {
                throw new InvalidInputException("Member ID must be a number.");
            }
            ...
            if (issueDate == null) {
                throw new InvalidInputException("Please select an issue date.");
            }
