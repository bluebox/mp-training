...
public class Book { 
	private int bookId; private String title; private String author; private String category; private char status; // 'A' (Active) or 'I' (Inactive) 
	private char availability; // 'A' (Available) or 'I' (Issued)
	public Book() {}
