...
from toursapp.models import Coupon, Tour, Vehicle
...
class User(models.Model):
    ...
    image = models.TextField(default='https://res.cloudinary.com/dklq1vuce/image/upload/v1664469247/smiley-dp_nu8kdg.jpg')
