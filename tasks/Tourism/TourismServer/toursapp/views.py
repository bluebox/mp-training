...
from toursapp.models import Coupon, Enquiry, Place, Tour, Vehicle
from toursapp.serializers import CouponSerializer, EnquirySerializer, PlaceSerializer, TourDetailSerializer, TourSerializer, \
    VehicleSerializer
