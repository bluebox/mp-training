        ...
        <div className="container mt-4">
            ...
            <div id="carouselExampleIndicators" className="carousel slide bg-dark text-white py-5" data-bs-ride="carousel">
                ...
                <div className="carousel-inner">
                    {testimonialData && testimonialData.map((row, index) =>
                        <div className={index === 0 ? 'carousel-item text-center active' : 'carousel-item text-center'} key={row.id}>
                            <figure class="text-center">
                                <blockquote class="blockquote">
                                    <p>{row.review}</p>
                                </blockquote>
                                <figcaption class="blockquote-footer">
                                    <b>Course - </b><span className="text-white">{row.course.title} </span><cite title="Source Title"><b>/ Review By :- </b><span className="text-light">{row.student.user.first_name}</span></cite>
                                </figcaption>
                            </figure>
                        </div>
                    )}
