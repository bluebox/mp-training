# Generated by Django 3.0.5 on 2022-09-28 06:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subject_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='fpapp.Subject')),
            ],
        ),
        migrations.AddField(
            model_name='subject',
            name='teacher_id',
            field=models.ManyToManyField(to='fpapp.Teacher'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='fpapp.Student')),
            ],
        ),
        migrations.CreateModel(
            name='Evaluation',
