    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_superuser7', models.BooleanField(default=False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('designation', models.CharField(choices=[('Doctor', 'Doctor'), ('Nurse', 'Nurse'),
                 ('Lab Technician', 'Lab Technician'), ('Sample Collector', 'Sample Collector'),
                  ('Receptionist', 'Receptionist')], max_length=100)),
                ('qualification', models.CharField(max_length=100)),
                ('salary', models.IntegerField()),
                ('years_of_experience', models.IntegerField()),
                ('status', models.CharField(choices=[('occupied', 'occupied'), ('available', 'available')],
                                            default='available', max_length=100)),
                ('branch', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                             to='appointment.branch')),
