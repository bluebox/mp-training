...
class Appointment(models.Model):
    ...
    lab_technician = models.ForeignKey(Staff, on_delete=models.SET_NULL, null=True, blank=True,
                                       related_name='lab_technician')
    sample_collector = models.ForeignKey(Staff, on_delete=models.SET_NULL, null=True, blank=True,
