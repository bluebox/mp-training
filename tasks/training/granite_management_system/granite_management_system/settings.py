"""
Django settings for granite_management_system project.
...
SECRET_KEY = 'django-insecure-5*v%+apslv+9$lquao4n16rf$9k@#e)^$$y_7ta22t1*hhuit)'
...
WSGI_APPLICATION = 'granite_management_system.wsgi.application'
