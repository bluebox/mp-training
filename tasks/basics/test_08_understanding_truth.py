...
def test_truth_values():
    assert is "empty string is treated as false" == truth_test("", "empty string")
    ...
    assert "white space is treated as false" == truth_test(" ", "white space")
...
- different values that can be treated as true or false
- 'assert False == ("" == True)' these work differently than expected
- undertood truth values
"""
