...
def test_function_call_with_keyword_arguments():
    ...
    assert [1, 20, 3]  == demo(1, second=20) #adding 1st argument as 1
    assert [1, 20, 30]  == demo(1, second=20, third=30) #adding 1st argument as 1
...
-args is a normal arguments
-kwargs is a key argument 
-
"""
