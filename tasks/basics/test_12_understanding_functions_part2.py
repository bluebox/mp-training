...
<<<<<<< HEAD:Tasks/pybasics/basics/test_12_understanding_functions_part2.py
from tasks.placeholders import *
=======
from tasks.placeholders import *
>>>>>>> 60a8770156443a866425d99b2119f19709472edd:tasks/basics/test_12_understanding_functions_part2.py
...
def test_function_with_keyword_args():
    ...
    assert {'age': 10, 'height': 100} == demo_with_keyword_args(
        "jack", "address", age=10, height=100)
    assert {'address': "address", 'age': 10, 'height': 100} == demo_with_keyword_args(
        "jack", address="address", age=10, height=100)
