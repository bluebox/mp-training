...
NOTES = '''
This lesson introduces the basic assert statement in python. assert is generally used
 to 'assert' the truth of anexpression. It takes the form assert <expr>, <optional message>.
  If <expr> evaluates to False an AssertionError is raised withthe <optional message>. If is
...
def test_assert_true_with_message():
    assert True, "This is the failure message" # replace ___ with 
    # True to stop seeing the assertion error
