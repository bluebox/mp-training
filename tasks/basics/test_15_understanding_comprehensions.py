...
import string
""" program to understand comprehension """
def is_even(x):
    """ function to check even numbers"""
    return x % 2 == 0

def square(x):
    """ function to check square of number """
    return x*x

def test_lc_basic():
    """ function to test lc basic """
    input = [1, 2, 3]
...
def test_dc_conditional():
    """ function to do test conditional """
...
- various conditionals statements
-workflow of statements
