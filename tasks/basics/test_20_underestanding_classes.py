...
def test_classes_bound_and_unbound_methods():
    """classes bound and unbound methods"""
    class Queue(object):
        def __init__(self, name):
            self.name = name
            self._queue = []
    ...
    # assert "AttributeError" == q1_push.__self__      #bound method
...
- classes
- class bound and unbound methods
- constructor is only revoked when an object is created not when a class is called
"""
