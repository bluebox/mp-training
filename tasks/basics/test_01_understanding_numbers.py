...
""" Program to understand python number system"""
def test_numbers_types():
    """ function to check type of number"""
...
def test_numbers_int_arithmetic_operations():
    """ function to check int number in python"""
    assert 30 == 10 + 20
    assert 200 == 10 * 20
    assert 32 == 2 ** 5
    assert -10 == 10 - 20
    assert 2.3333333333333335 == 7 / 3
test_numbers_int_arithmetic_operations()
...
def test_numbers_string_to_int():
    ...
    assert 63 == int("77", 8)
test_numbers_string_to_int()

def test_numbers_int_to_string():
    """ function to convert int to other type"""
    assert '0o12' == oct(10)
    assert '0x64' == hex(100)
    assert '0b11111111' == bin(255)
test_numbers_int_to_string()
