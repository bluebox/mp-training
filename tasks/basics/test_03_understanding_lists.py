...
def test_list_common_methods():
    ...
    assert ["banana", "litchi", "guava", "grape1", "orange"] == fruits

    fruits.insert(0, "banana")
    assert ['banana','banana', 'litchi','guava','grape1','orange'] == fruits

    fruits.extend(["litchi", "guava"])
    assert ['banana','banana','litchi', 'guava','grape1','orange','litchi','guava'] == fruits

    fruits.reverse()
    assert ['guava', 'litchi', 'orange', 'grape1', 'guava', 'litchi', 'banana', 'banana']  == fruits

    fruits.pop()
    assert  ['guava', 'litchi', 'orange', 'grape1', 'guava', 'litchi', 'banana'] == fruits

    fruits.pop(0)
    assert ['litchi', 'orange', 'grape1', 'guava', 'litchi', 'banana'] == fruits
