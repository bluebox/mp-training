...
def test_if():
    '''if statement works based on condition'''
    value = 1
    if True:
        value = 2
    assert 2 == value
...
- control flow - if , if else are conditional statements 
- loops are for and while loops - which check condition and control work flow
- learnt about break, continue
"""
