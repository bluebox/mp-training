...
def test_valid_dictionary_keys():
    ...
    try:
        ...
        # No we don't reach here because tuple is valid dict_key because it is not a mutable element
    ...
    try:
        ...
        # Yes we reach because the tuple is a mutable element, so it's not a valid dict_key
...
- we can obtain the list of keys , values and items in dict using the separate inbuilt methods and from python 3 dict have become ordered and they are accessed
