...
from tasks.basics.test_05_understanding_dicts import NOTES
...
-sets cannot have repitative element
-when we try to create empty set its type becomes dict
-sets are unordered
"""
