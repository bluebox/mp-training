...
def test_string_membership():
    ...
    str_1 = "c"
    str_2 = "a"
    assert False is (str_1 in "apple")  #is there a precedence issue here?
    assert True is (str_2 in "apple")
    string_inp = "app"
    assert True is (string_inp in "apple")  # '==' and 'in' operators have same precedence are interpreted from left to right in the expression
