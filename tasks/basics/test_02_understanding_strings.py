...
-performing concatenation to add two strings
-slicing in strings and finded the length of the string using len() built in function.
-.format the specified value(s) and insert them inside the string's placeholder and  checked whether there a given character is in string or not by using "in" operator
"""
