...
'''
# Look a the package1 and package2 directories before starting...

def test_package_basic_import():
    """basic docstring for pylint testing clear_sys_modules()"""
...
def test_package_sub_packages():
    ...
    # print(m1.__doc__)
    # assert sys.modules == ("package1.subpackage.m1" in sys.modules)
