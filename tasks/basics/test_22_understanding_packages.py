...
def test_package_import_failure():
    ...
    why_it_failed = """ImportError occurs when python doesnot find a module or member module, or a 
                     module that cannot be imported. In this case package2 does not have __init__.py"""
