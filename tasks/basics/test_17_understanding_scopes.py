...
def test_scope_is_bound_at_definition_time():
    ...
    try:
        ...
        count = 30
        print(value)
    except UnboundLocalError as n_e: # what happens when you read a variable before initializing it?
...
-we can declare the value in globally and locally with same variable name
-value of local variable differ from global variable
-
"""
