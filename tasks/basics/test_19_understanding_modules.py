...
def test_module_is_an_object():
    ...
    assert 'placeholder' == placeholders.__name__
...
def test_module_star_import():
    ...
    assert ModuleNotFoundError == (s2 - s1)  # what did module3 import bring in.
    assert ModuleNotFoundError == (s3 - s2)  # what did module4 import bring in.
