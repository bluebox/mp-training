...
def test_module_star_import():
    ...
    assert set(['m3_func1', 'm3_func2'])== (s2 - s1)  # what did module3 import bring in.
...
- modules usually contains a set of function, data and class definitions which provide a specific functionality.
