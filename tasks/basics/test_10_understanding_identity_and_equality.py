...
- Python is internally implemented such that "small" integers are stored in a different way than larger integers 
  and the is operator can tell the difference.
- None is a builtin function which allows us to use is operator with it
- use equality and inequality operators instead of using is operator (less chances of commiting a mistake)
"""
