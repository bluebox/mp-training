...
# learned about identity and equality operator
# When interger is small like a = 10 and b = int("10") both a & b points to the same object in the memory.
# But when memory is large they both point to different objects in memory.
# None , whenever referred , points to the same object
# """
#
