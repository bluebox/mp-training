...
public class Task8 {
    public static void main(String[] args) throws IOException {
        String inputFilePath = "/home/mphs/Downloads/Sample_Employee_WorkLogs.xlsx";
        String outputFilePath = "/home/mphs/Desktop/ExcelOutputFiles/Task8Output.xlsx";
            ...
            for (Row row : sheet) {
                ...
                if (dateCell != null) {
                    if (dateCell.getCellType() == CellType.NUMERIC && DateUtil.isCellDateFormatted(dateCell)) {
                        emp.setDate(LocalDate.parse((CharSequence)dateCell.getDateCellValue()));
        ...
        Map<String, Map<LocalDate, Double>> weeklyEffort = employees.stream()
        	    .collect(Collectors.groupingBy(EmployeeWorkLog::getProjectId,
        	        Collectors.groupingBy(
        	            e -> e.getDate().with(TemporalAdjusters.previousOrSame(DayOfWeek.MONDAY)),
        	            TreeMap::new,
