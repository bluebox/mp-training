...
class PracticeModel(models.Model):
    ...
    email = models.EmailField(verbose_name='email id',max_length=100,null=True)
    file = models.FileField(validators=[FileExtensionValidator( ['pdf'] )],null=True)
    image = models.ImageField(validators=[FileExtensionValidator( ['png','jpg'] )],null=True)