...
public class MultiCategoryEmployees {
	...
	public void employees()
	{
        ...
        try (FileWriter writer = new FileWriter("/home/mphs/Desktop/mp-training/tasks/EmployeeProductivityAnalysis/CSVFileHandling/multi_category_employees.xlsx")) {
            for (String[] row : csvRows) {
                writer.write(String.join(",", row));
                writer.write("\n");
            }
            System.out.println("\nCSV file written: multi_category_employees.xlsx");
        } catch (IOException e) {
