...
public class FacultyDAO {
    ...
    public String approveEvent(int eventId,String userid) {
        String sql = "UPDATE event SET eventstatus = 'Approved',Approved_by=?,Approved_time=? WHERE eventid = ? AND eventstatus = 'Pending'";
    ...
    public int markAttendance(String userid,int eventid,Attendenceenum presence,String Facultyid) throws EventnotRegistered {
        ...
        return jdbcTemplate.update(sql,userid,eventid,presence.getType(),Facultyid,LocalDate.now());
