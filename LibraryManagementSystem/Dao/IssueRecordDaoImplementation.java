...
public class IssueRecordDaoImplementation implements IssueRecordDao {
    ...
    public boolean issueBook(IssueRecord record) {
        ...
        String updateAvailabilitySql = "UPDATE books SET Availability='I' WHERE Id=?";
    ...
    public boolean returnBook(int issueId) {
        ...
        String updateAvailabilitySql = "UPDATE books SET Availability='A' WHERE Id=(SELECT BookId FROM issue_records WHERE IssueId=?)";
