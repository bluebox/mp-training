...
def test_tuple_unpacking():
    ...
    try:
        ...
        print ("ve=>too many values to unpack (expected 2)" ) # observe what is printed here. =>In Python 3, printing values changed from being a distinct statement to being an ordinary function call, so it now needs parentheses
