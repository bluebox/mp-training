...
import jwt
import datetime
from .managers import getSelectedSeats,getTicket,getBookingHistory,getHallsFilteredByDate,getHallsFilteredByMovie,getDataFilteredByHallandDate,getSingleTheatrebyId,hallFilteredByDate,cancelTickets,getowners,langmovies,ownertheatre,theatrelist,halllist
