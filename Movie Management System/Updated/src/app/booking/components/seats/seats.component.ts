...
{ 
  ...
  if(this.selectedSeatsN.includes(i.toString()+j.toString())){
    ...
    console.log("first else",this.number,this.chosen)
    if(this.chosen<this.number){
      console.log("2nd if",this.number)
    this.selectedSeatsN.push(seat)
    console.log("first else",this.selectedSeatsN)
    ...
    else if(typeof(this.number)!=='undefined')
    {
      ...
      this.selectedSeatsN.splice(0,1)
      this.selectedSeatsN.push(seat)
      console.log("2nd else",this.selectedSeatsN)
    }
  }
...
DeductSeats(){
  ...
  //   }
  // }
  this.price=this.ss.length*this.hallData.baseprice
  console.log(this.price)
  this.dialog.open(ConfirmationComponent,{data:{'selectedSeats':this.ss,'hallid':this.hallid,'price':this.price}})
}
  selected(){
    this.clicked++
