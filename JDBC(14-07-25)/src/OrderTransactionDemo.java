...
public class OrderTransactionDemo {
    public static void main(String[] args) {
        ...
        try (Connection conn = DriverManager.getConnection(jdbcUrl, username, password);
            ...
            } else throw new SQLException("Failed to get order ID.");
            stmt.executeUpdate("INSERT INTO OrderDetails (order_id, product_name, quantity, price) " +
                    "VALUES (" + orderId + ", 'Product A', 2, 19.99)");
            stmt.executeUpdate("INSERT INTO OrderDetails (order_id, product_name, quantity, price) " +
                    "VALUES (" + orderId + ", 'Product B', 1, 9.99)");
            conn.commit();
