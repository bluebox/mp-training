...
const UpdateEvent = () => {
  const [formData, setFormData] = useState({
    ...
    console.log("Updated data for Event : ", formData);  
    try {
        await axios.put("http://localhost:8080/api/eventCreation/updateEvent", formData);
        setResponseMessage("Event updated successfully!");
    } 
    catch (error) {
        console.log("Error : ", error.response);  
        setResponseMessage("Event failed to update!");
    }
    };
    ...
    return (
        <div>
            ...
            <form onSubmit={handleClick}>
                ...
                <input type="number" name="updated_by" id="" value={formData.updated_by} onChange={handleChange} placeholder="enter number" required /><br /><br /> 
...
// const UpdateEvent = ({event_id,user_id}) => {
//   const [formData, setFormData] = useState({
//         name:"",
//         start_date:"",
//         end_date:"",
...
//           try {
//             const response = await axios.get(`http://localhost:8080/api/eventCreation/event/${event_id}`);
