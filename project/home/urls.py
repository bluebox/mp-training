...
urlpatterns = [
    ...
    path('api/users/', usersApi, name = 'users'),
    ...
    path('api/post-discussion/<str:problemName>/<str:username>/', postDiscussionApi, name = 'postDiscussionApi'),
    path('api/problems/category/<str:category>/', categoryApi, name='categoryApi'),
    path('api/discussions/<str:problemName>/', discussionsApi, name='discussionsApi'),
