...
public class MemberDAOImpl implements MemberDAO {
	...
	public Member getMemberById(int id) {
		...
		try {
			...
			if (rs.next()) {
				member = new Member(rs.getInt("id"),rs.getString("name"),rs.getInt("age"),rs.getString("contact_details"));
	...
	public List<Member> getAllMembers() {
		...
		try {
			...
			while (rs.next()) {
			Member	member = new Member(rs.getInt("id"),rs.getString("name"),rs.getInt("age"),rs.getString("contact_details"));
				members.add(member);
			}
