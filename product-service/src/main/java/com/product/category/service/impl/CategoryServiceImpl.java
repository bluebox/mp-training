...
public class CategoryServiceImpl implements CategoryService{
    ...
    private final List<CategoryRequest> categoryRequestList = new ArrayList<>();
        ...
        @Override
        public void getCategoryRequestService(CategoryRequestSearchCriteria searchCriteria) {
            if (searchCriteria == null) {
                throw new IllegalArgumentException("Search criteria must not be null.");
            }
            
            categoryDAO.getRequest(searchCriteria);
        }
        ...
        @Override
        public void getCategoryService(CategorySearchCriteria searchCriteria) {
            if (searchCriteria == null) {
                throw new IllegalArgumentException("Search criteria must not be null.");
            }
            
            categoryDAO.get(searchCriteria);
        }
 }
