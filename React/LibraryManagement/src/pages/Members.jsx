  ...
  return (
    <div className="p-6">
      ...
      {(showDialog || editDialog) && (
        <div className="flex items-center justify-center fixed inset-0 bg-black bg-opacity-40 z-50 p-4">
            ...
            >
              <Form className="space-y-4">
                ...
                <div className="flex justify-end gap-2">
                  <button type="button" onClick={() => { setShowDialog(false); setEditDialog(false); }} className="px-4 py-2 bg-gray-300 rounded hover:bg-gray-400">Cancel</button>
